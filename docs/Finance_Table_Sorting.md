...
## התנהגות המיון
- לקוחות ממוינים לפי סכום חיובים כולל (מהגבוה לנמוך)
- המיון מתעדכן בהתאם לסינון החודש הנבחר

---

## עדכון 08/02/2026 - הערות וארכיון חיובים

### שדה הערות בחיובים
- נוסף שדה "הערות" בטופס הוספת חיוב חדש
- מאפשר להרחיב בכמה מילים על מה היה החיוב
- ההערות מוצגות בפירוט החיובים ובארכיון

### ארכיון חיובים ששולמו
- חיובים ששולמו מועברים אוטומטית לארכיון
- הארכיון מוצג בסקשן נפרד מתחת לטבלה הראשית
- ניתן לפתוח/לסגור את הארכיון בלחיצה
- ניתן להחזיר חיוב מהארכיון לחיובים פתוחים

### מבנה התצוגה
```
+----------------------------------+
|  טבלת לקוחות (חיובים פתוחים)     |
+----------------------------------+
|  [v] ארכיון חיובים (X חיובים)    |
+----------------------------------+
|  טבלת ארכיון (כשפתוח)            |
|  - לקוח | תיאור | תאריך | סכום   |
+----------------------------------+
```
